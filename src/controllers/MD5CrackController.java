...
public class MD5CrackController {
    ...
    public void initialize() throws NoSuchAlgorithmException {
        this.messageDigest = CommonUtils.getMessageDigest("MD5");
    ...
    void handleCreateTableModeButton(ActionEvent event) throws IOException {
        this.stageController.switchMD5(StageController.MD5_CREATE, event);
    }
        ...
        try {
            new Thread(() -> {
                try {
                    ...
                    this.passwordCracker = new PasswordCracker(PasswordCracker.MD5_ALGORITHM, this.selectedFile, charsetType, minPasswordLength, maxPasswordLength, chainsPerTable, chainLength);
